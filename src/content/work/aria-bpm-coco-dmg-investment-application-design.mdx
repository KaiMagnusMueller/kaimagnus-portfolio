...
I want to highlight my work on a new [table component system](/work/designing-a-grid-system-with-great-designer-experience), based on AG Grid, the new framework used in many IDS applications from now on. I optimized the components from the beginning for 'designer experience', making sure we had high performance and flexibility.
