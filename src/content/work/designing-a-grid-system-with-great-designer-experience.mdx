...
Similarly, 'designer experience' in the context of component libraries stands for ergonomic components that follow a designers mental model. Whey should not get in the way or need detaching, slot components should be used for flexibility and a good balance between properties and nested components is important. 
