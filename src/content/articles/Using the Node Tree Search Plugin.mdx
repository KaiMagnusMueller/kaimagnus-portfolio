...
Central feature of this plugin is the layer tree. When a layer is selected, the layer tree displays all of its ancestors up to the current page. By clicking on a parent from the tree, users can select all layers matching the selected element inside the chosen parent. This way, selections of repeated elements that normally take careful box dragging become much less cumbersome.
