...
datePublished: 2020-02-04T15:22:00Z
...
<div style="padding:56.25% 0 0 0;position:relative;">
    <iframe
        src="https://player.vimeo.com/video/802828920?h=89c131a80b&title=0&byline=0&portrait=0"
...
export const _srcSet2 = [
    {
        ...
        alt: 'After searching, the results appear in the main exploration view together with important keywords. Users can select and open results to read or watch. To remember interesting information, they can click the "save" button to highlight that item on the graph.',
    },
    {
        title: 'Navigation',
    ...
    },
    {
        ...
        alt: 'Saved items are highlighted here as well. After exploring a broad selection of interesting items, users can save smaller quotes of the most important pieces of information.',
    },
    {
